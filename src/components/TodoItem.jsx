    ...
    <>
      <li className="flex bg-white rounded shadow-sm p-4 mt-4 first:mt-0">
        <div className="flex gap-x-4 mr-auto items-center">
          <div className="h-6 w-6 rounded-full  text-sm shadow-sm text-white  bg-teal-400 text-center content-center">
            {props.id + 1}
          </div>
          <div>
      ...
      <dialog
        ...
        className="rounded-md w-[480px] mx-auto mt-70"
      >
        <form onSubmit={submitForm} className="p-6">
          ...
          <div className="mt-2">
            {editing ? (
              ...
              "This will permenently delete this task."
            )}
          </div>
